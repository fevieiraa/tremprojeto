...
class ControleTrens {
    constructor() {
        this.listaTrens = [];
        this.estacoes = [
            { nome: "Jabaquara", posicao: 0, distancia: 1300 },
            { nome: "Conceição", posicao: 1, distancia: 1100 },
            { nome: "São Judas", posicao: 2, distancia: 1200 },
            { nome: "Saúde", posicao: 3, distancia: 1300 },
            { nome: "Praça da Árvore", posicao: 4, distancia: 1000 },
            { nome: "Santa Cruz", posicao: 5, distancia: 1100 },
            { nome: "Vila Mariana", posicao: 6, distancia: 1200 },
            { nome: "Ana Rosa", posicao: 7, distancia: 1300 },
            { nome: "Paraíso", posicao: 8, distancia: 1400 },
            { nome: "Vergueiro", posicao: 9, distancia: 1000 },
            { nome: "São Joaquim", posicao: 10, distancia: 1300 },
            { nome: "Liberdade", posicao: 11, distancia: 1100 },
            { nome: "Sé", posicao: 12, distancia: 1200 },
            { nome: "São Bento", posicao: 13, distancia: 1300 },
            { nome: "Luz", posicao: 14, distancia: 1400 },
            { nome: "Tiradentes", posicao: 15, distancia: 1200 },
            { nome: "Armênia", posicao: 16, distancia: 1300 },
            { nome: "Portuguesa-Tietê", posicao: 17, distancia: 1200 },
            { nome: "Carandiru", posicao: 18, distancia: 1300 },
            { nome: "Santana", posicao: 19, distancia: 1200 },
            { nome: "Jardim São Paulo", posicao: 20, distancia: 1400 },
            { nome: "Parada Inglesa", posicao: 21, distancia: 1300 },
            { nome: "Tucuruvi", posicao: 22, distancia: 0 } // Última estação
        ];
    

    
          this.distanciaTotal = 1500 * 22;  
          this.tempoTotal = 45; 
      ...
      this.listaTrens.forEach(trem => {
          ...
          if (tempoChegada !== undefined && tempoChegada >= 0 && !trensExibidos.includes(trem.numero)) {
              ...
              if (trem.posicao < estacao.posicao) {
                  ...
                  infoDiv.innerHTML += `Frota A ${trem.numero}: Chegará em ${tempoRestanteEmMinutos.toFixed(2)} minuto(s) (às ${horaFormatada})<br>`;
  ...
  function inicializarTrens() {
      ...
      controleTrens.adicionarTrem(10, 60, 18); 
      controleTrens.adicionarTrem(11, 60, 20); 
      atualizarInterface();
  }
